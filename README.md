...
| **中央应用个人后台** | `{central-domain}/{team}/dashboard`                | 团队成员：管理该团队下的租户及模块功能 |
| **租户应用管理后台** | `{tenant-domain}/admin`            | 租户内部管理，同样支持 Filament Shield 细粒度 RBAC |
| **租户应用个人后台** | `{tenant-domain}/{team}/dashboard` | 租户成员：管理该租户下的模块功能 |
