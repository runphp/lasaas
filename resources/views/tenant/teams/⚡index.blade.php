...
new #[Title('Teams')] class extends Component {
    ...
    public function createTeam(CreateTeam $createTeam): void
    {
        ...
        $this->redirectRoute('tenant.teams.edit', ['team' => $team->slug], navigate: true);
    }
...
<section class="w-full">
    ...
    <x-tenant::settings.layout :heading="__('Teams')" :subheading="__('Manage your teams and team memberships')">
                    ...
                    <div class="flex items-center gap-1">
                        <flux:tooltip :content="$team->role === 'member' ? __('View team') : __('Edit team')">
                            <flux:button
                                ...
                                :href="route('tenant.teams.edit', $team->slug)"
                                wire:navigate
