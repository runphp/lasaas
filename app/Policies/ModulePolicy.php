...
class ModulePolicy
{
    ...
    public function settings(AuthUser $authUser, Module $module): bool
    {
        return $authUser->can('Settings:Module');
    }

    public function uninstall(AuthUser $authUser, Module $module): bool
    {
        return $authUser->can('Uninstall:Module');
    }
}
